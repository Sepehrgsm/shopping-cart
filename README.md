...
showing my products in sites UI with reusable cards

### Products Detailes :

showing details of each product (full name , price , quantity , ...)

### shopping cart :

for calculating and showing amount of products selected in the cart

### Checkout Page:

A page for payment and checking out or fallback to shop more
